...
<body class="antialiased text-gray-800 bg-gray-50">
    ...
    <div class="max-w-6xl mx-auto px-6">
      <div class="flex items-center justify-between h-16">
        <a href="#home" class="flex items-center gap-3">
          <div class="w-10 h-10 bg-blue-600 text-white rounded-full flex items-center justify-center font-bold">W</div>
        ...
        <div class="flex items-center gap-3">
          <a href="{{ route('login') }}" class="px-4 py-2 border border-blue-600 text-blue-600 rounded-md hover:bg-blue-50">Login</a>
          <a href="{{ route('register') }}" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Get Started</a>
  ...
  <main class="pt-20">
      ...
      <div class="max-w-6xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <div class="mt-8 flex flex-wrap gap-3">
            <a href="{{ route('register') }}" class="px-6 py-3 bg-blue-600 text-white rounded-md shadow hover:bg-blue-700">
              Get Started
            </a>
            <a href="{{ route('login') }}" class="px-6 py-3 border border-blue-600 text-blue-600 rounded-md hover:bg-blue-50">
              Login
            </a>
          ...
          <div class="mt-8 text-sm text-gray-500">
            <span class="font-medium">For institutions:</span> reduces paperwork, centralizes records, and improves verification.
          </div>
        </div>
        ...
        <div class="relative">
          <div class="bg-gradient-to-tr from-blue-50 to-white rounded-2xl p-6 shadow-lg">
            ...
            <div class="bg-white rounded-lg p-5 border">
              ...
              <div class="mt-4">
                <p class="text-sm text-gray-600">Summary: Assisted in backend API integration and database migration.</p>
              </div>

              <div class="mt-4 flex items-center gap-3">
                <img src="https://via.placeholder.com/48" alt="passport" class="rounded-full w-12 h-12 border">
                <div>
      ...
      <div class="grid md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <p class="mt-4 text-gray-600">
            ...
            Students submit weekly summaries, upload the company stamp & signature once, and receive a final approved PDF
            signed by the SIWES officer.
          </p>
          <ul class="mt-6 space-y-2 text-gray-700">
            <li class="flex items-start gap-3"><span class="text-blue-600 mt-1">•</span> Easy weekly submission</li>
            <li class="flex items-start gap-3"><span class="text-blue-600 mt-1">•</span> Company endorsement applied automatically</li>
            <li class="flex items-start gap-3"><span class="text-blue-600 mt-1">•</span> Centralized SIWES approvals</li>
          </ul>
        </div>
        <div>
          <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=900&auto=format&fit=crop&ixlib=rb-4.0.3&s=6b0a7d8f4f3b7b4b4d9637f6b78f0c46" alt="students" class="rounded-xl shadow">
        </div>
      </div>
    </section>
      ...
      <div class="max-w-6xl mx-auto px-6 py-16">
        ...
        <div class="mt-10 grid md:grid-cols-4 gap-6">
          ...
          <div class="p-6 bg-gray-50 rounded-lg text-center">
            ...
            <p class="mt-2 text-sm text-gray-600">Upload company stamp & signature once — applied to all weeks.</p>
          </div>
          <div class="p-6 bg-gray-50 rounded-lg text-center">
    ...
    <section id="features" class="max-w-6xl mx-auto px-6 py-16">
      ...
      <div class="mt-10 grid md:grid-cols-3 gap-6">
        <div class="p-6 bg-white rounded-lg shadow-sm">
          ...
          <p class="mt-2 text-sm text-gray-600">A standard form to keep entries consistent and professional.</p>
        </div>

        <div class="p-6 bg-white rounded-lg shadow-sm">
          <h3 class="font-semibold">Company Endorsement</h3>
          <p class="mt-2 text-sm text-gray-600">Upload stamp & signature once — the system applies it to all weekly pages.</p>
        </div>

        <div class="p-6 bg-white rounded-lg shadow-sm">
          <h3 class="font-semibold">Auto PDF Generation</h3>
          <p class="mt-2 text-sm text-gray-600">Download a final PDF containing stamps and official signatures.</p>
        </div>
        ...
        <div class="p-6 bg-white rounded-lg shadow-sm">
          ...
          <p class="mt-2 text-sm text-gray-600">Files and student data are stored securely with controlled access.</p>
        </div>
    ...
    <section id="privacy" class="bg-blue-50 border-t">
      <div class="max-w-6xl mx-auto px-6 py-16 text-center">
        ...
        <p class="mt-4 text-gray-600 max-w-2xl mx-auto">
          We collect only the data required for SIWES documentation (student details, passport photo, weekly logs, uploaded stamps/signatures).
          Data is stored securely and only accessible to authorized officers.
        </p>

        <div class="mt-6 flex justify-center gap-3">
          <button id="openPrivacy" class="px-5 py-3 bg-white border rounded-md hover:bg-gray-100">Read Full Policy</button>
          <a href="#contact" class="px-5 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700">Contact Support</a>
        </div>
      </div>
    </section>
        ...
        <div>
          ...
          <form id="contactForm" class="bg-white p-6 rounded-lg shadow-sm space-y-4">
            <div>
              ...
              <input type="text" name="name" class="mt-1 block w-full border rounded px-3 py-2" placeholder="John Doe" required>
            </div>

            <div>
              <label class="text-sm font-medium">Your email</label>
              <input type="email" name="email" class="mt-1 block w-full border rounded px-3 py-2" placeholder="you@example.com" required>
            </div>

            <div>
              <label class="text-sm font-medium">Message</label>
              <textarea name="message" rows="4" class="mt-1 block w-full border rounded px-3 py-2" placeholder="How can we help?" required></textarea>
            </div>
    ...
    <footer class="border-t mt-8">
      <div class="max-w-6xl mx-auto px-6 py-6 flex flex-col md:flex-row items-center justify-between text-sm text-gray-500">
  ...
  <div id="privacyModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/40 p-6">
    <div class="bg-white max-w-3xl w-full rounded-lg overflow-auto max-h-[80vh]">
      ...
      <div class="p-6 space-y-4 text-gray-700">
        <p><strong>Overview:</strong> We collect student data (name, matric number, passport photo), weekly logs, and uploaded company stamps/signatures strictly for SIWES documentation and verification.</p>

        <p><strong>Storage & Access:</strong> All files are stored securely on our server. Only authenticated SIWES officers and the student can access their logbooks.</p>

        <p><strong>Retention:</strong> Data is retained for the duration of the student’s training and for institutional record-keeping. You can request deletion via the support email.</p>

        <p><strong>Security:</strong> We use standard web security practices (password hashing, protected storage paths). For production, ensure HTTPS and server hardening.</p>
